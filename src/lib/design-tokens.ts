...
export const lightColors = {
  ...
  /** Loople brand blue from Figma feature tag (#3367c7). */
  brand: '#3367c7',
  /** Soft blue surface behind brand labels (#e8f0ff). */
  brandMuted: '#e8f0ff',
  /** Cool canvas behind feature media (#f5f7fd). */
  surface: '#f5f7fd',
  /** Accent pill families — soft fill + foreground text (from Loople app tokens). */
  coralMuted: '#ffebee',
  coralForeground: '#c62828',
  amberMuted: '#fffbeb',
  amberForeground: '#b45309',
  emeraldMuted: '#ecfdf5',
  emeraldForeground: '#047857',
  violetMuted: '#faf5ff',
  violetForeground: '#7e22ce',
...
export const darkColors = {
  ...
  accentForeground: CYAN_FOREGROUND,
  brand: '#6b93e0',
  brandMuted: 'oklch(0.22 0.04 255)',
  surface: 'oklch(0.17 0.01 255)',
  coralMuted: 'oklch(0.22 0.04 25)',
  coralForeground: 'oklch(0.78 0.10 25)',
  amberMuted: 'oklch(0.24 0.04 75)',
  amberForeground: 'oklch(0.82 0.10 75)',
  emeraldMuted: 'oklch(0.22 0.04 155)',
  emeraldForeground: 'oklch(0.80 0.10 155)',
  violetMuted: 'oklch(0.22 0.05 300)',
  violetForeground: 'oklch(0.78 0.12 300)',

...
const badgeToneClasses: Record<BadgeTone, string> = {
  info: 'bg-ds-brand-muted text-ds-brand',
...
const SectionHeader = (props: SectionHeaderProps) => (
  <div className="mb-12 max-w-2xl">
    ...
    <RevealHeading
      ...
      trigger="scroll"
      id={props.id}
      className="scroll-mt-28 text-3xl font-bold tracking-tight sm:text-4xl"
    >
      {props.title}
    </RevealHeading>
    {props.description ? (
...
const toc = [
  { href: '#ds-colors', label: 'Colors' },
  { href: '#ds-typography', label: 'Typography' },
  { href: '#ds-spacing', label: 'Spacing' },
  { href: '#ds-radii', label: 'Radii' },
  { href: '#ds-shadows', label: 'Shadows' },
  { href: '#ds-buttons', label: 'Buttons' },
  { href: '#ds-forms', label: 'Inputs' },
  { href: '#ds-cards', label: 'Cards' },
  { href: '#ds-navigation', label: 'Navigation' },
  { href: '#ds-icons', label: 'Icons' },
  { href: '#ds-badges', label: 'Badges' },
  { href: '#ds-commerce', label: 'Commerce' },
  { href: '#ds-motion', label: 'Motion' },
] as const;
    ...
    <div className="bg-ds-background text-ds-foreground">
      ...
      <section className="px-6 pt-20 pb-16 sm:pt-28 sm:pb-24">
        <div className="mx-auto max-w-6xl">
          ...
          >
            Internal reference for Loople tokens, primitives, and shared components. Organized by
            category for design and engineering review.
          </RevealLines>
        </div>
      </section>

      <div className="mx-auto flex max-w-6xl gap-12 px-6 pb-32 sm:pb-40 lg:gap-16">
        <aside className="sticky top-24 hidden h-fit w-44 shrink-0 lg:block">
          <p className="mb-4 text-[10px] font-medium tracking-[0.14em] text-ds-muted-foreground uppercase">
            On this page
          </p>
          <nav aria-label="Design system sections">
            <ul className="space-y-2 border-l border-ds-border/60">
              {toc.map((item) => (
                <li key={item.href}>
                  <a
                    href={item.href}
                    className="-ml-px block border-l border-transparent py-1 pl-4 text-sm text-ds-muted-foreground transition-colors hover:border-ds-foreground hover:text-ds-foreground"
                  >
                    {item.label}
                  </a>
                </li>
        ...
        <main className="min-w-0 flex-1 space-y-32 sm:space-y-40">
          <section aria-labelledby="ds-colors">
            <SectionHeader
              id="ds-colors"
              eyebrow="01 — Colors"
              title="Semantic palettes."
              description="Light and dark values for each token. Brand blue is shared with the Loople feature tag; cyan remains the primary CTA accent."
            />
          ...
          <section aria-labelledby="ds-typography">
            <SectionHeader
              ...
              description="Compose with the scale below — never invent intermediate sizes."
            />
            ...
            <ul className="space-y-3">
              {Object.entries(spacing).map(([name, value]) => (
                <li key={name} className="flex items-center gap-6 py-1.5">
                  ...
                  <div
                    aria-hidden="true"
                    className="h-3 rounded-ds-sm bg-ds-brand"
                    style={{ width: value }}
                  />
          ...
          <section aria-labelledby="ds-shadows">
            <SectionHeader
              ...
              description="Reach for elevation only when an element needs to lift off the canvas."
            />
            <Stagger
          ...
          <section aria-labelledby="ds-buttons">
            <SectionHeader
              ...
              description="The cyan primary is the shared CTA. Other variants stay quiet."
            />
          ...
          <section aria-labelledby="ds-forms">
            <SectionHeader id="ds-forms" eyebrow="07 — Inputs" title="Quiet inputs, clear focus." />
          ...
          <section aria-labelledby="ds-cards">
            <SectionHeader id="ds-cards" eyebrow="08 — Cards" title="Composable surfaces." />
          ...
          <section aria-labelledby="ds-navigation">
            <SectionHeader
              id="ds-navigation"
          ...
          <section aria-labelledby="ds-icons">
            <SectionHeader
              id="ds-icons"
              eyebrow="10 — Icons"
              title="Stroke icons, 1.5 weight."
              description="No shared icon package yet — inline SVGs match this stroke language until a set is formalized."
            />
            <div className="flex flex-wrap gap-6 text-ds-foreground">
              <span className="flex size-12 items-center justify-center rounded-ds-md border border-ds-border bg-ds-card">
                <DemoIcon />
              </span>
              <span className="flex size-12 items-center justify-center rounded-ds-md border border-ds-border bg-ds-card text-ds-brand">
                <DemoIcon />
              </span>
              <span className="flex size-12 items-center justify-center rounded-ds-md bg-ds-brand text-white">
                <DemoIcon />
              </span>
            </div>
          </section>
          ...
          <section aria-labelledby="ds-badges">
            <SectionHeader id="ds-badges" eyebrow="11 — Badges" title="Status, not decoration." />
          ...
          <section aria-labelledby="ds-commerce">
            <SectionHeader
              id="ds-commerce"
              eyebrow="12 — Commerce"
              title="Boilerplate commerce cards."
              description="Present in the shared library; unused on the Loople homepage for now."
            />
            <div className="grid gap-6 lg:grid-cols-2">
              <ProductCard
                name="Sample product"
                description="Commerce primitive retained from the boilerplate."
                imageSrc="/assets/images/canon-plus-logo.png"
                imageAlt="Sample product placeholder"
                price="$48"
                badge="Demo"
                rating={4.5}
                ctaLabel="View"
              ...
              <OfferCard
                title="Starter"
                description="Offer card for pricing strips and promo grids."
                price="$29"
                priceSuffix="/mo"
                badge="Best value"
          ...
          <section aria-labelledby="ds-motion">
            <SectionHeader
              ...
              description="RevealHeading, RevealLines, Stagger, and LogoCarousel share the GSAP motion language."
            />
            <div className="space-y-10">
              <RevealHeading
                as="h3"
              ...
              <RevealLines
                as="p"
                trigger="scroll"
                className="max-w-xl text-base text-ds-muted-foreground"
              >
                Line reveal for supporting copy. Prefer these helpers over one-off GSAP timelines.
              </RevealLines>
              <LogoCarousel logos={demoLogos} ariaLabel="Logo carousel demo" speed={20} />
            </div>
          </section>
          ...
          <section aria-labelledby="ds-info" className="border-t border-ds-border/60 pt-16">
            ...
            <p className="mt-3 max-w-2xl text-base leading-relaxed text-ds-foreground/85">
              ...
              . Keep both in sync when adding new values. Reference colors via Tailwind utilities
              like <code className="font-ds-mono text-sm text-ds-foreground">bg-ds-brand</code>;
